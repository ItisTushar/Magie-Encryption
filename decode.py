...
def decode(pgn_string: str, output_file_path: str):
    ...
    # Extract file extension from the first game's Event header
    file_extension = games[0].headers.get("Event", ".bin")
    output_file_path = output_file_path + file_extension
...
if __name__ == "__main__":
    with open("output.pgn", "r") as f:
        pgn_input = f.read()
    decode(pgn_input, "outputs/final")