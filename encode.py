...
def count_future_moves(board: Board, move):
...
def encode(file_path: str):
    ...
    while True:
        ...
        if (
            ...
            pgn_board = pgn.Game()
            pgn_board.headers["Event"] = os.path.splitext(file_path)[1]  # Store file extension in Event
...
if __name__ == "__main__":
    pgn_output = encode("inputs/img1.jpg")
